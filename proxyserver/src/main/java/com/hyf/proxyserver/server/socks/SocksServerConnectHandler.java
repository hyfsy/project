...
public final class SocksServerConnectHandler extends SimpleChannelInboundHandler<SocksMessage> {
    ...
    public void channelRead0(final ChannelHandlerContext ctx, final SocksMessage message) throws Exception {
        if (message instanceof Socks4CommandRequest) {
            ...
            InetSocketAddress targetSocketAddress = InetSocketAddress.createUnresolved(request.dstAddr(), request.dstPort());
            ctx.channel().attr(ProxyUtils.TARGET_ADDRESS).setIfAbsent(targetSocketAddress);
            ...
            promise.addListener(new FutureListener<Channel>() {
                ...
                public void operationComplete(final Future<Channel> future) throws Exception {
                    ...
                    if (future.isSuccess()) {
                        ChannelFuture responseFuture =
                                ctx.channel().writeAndFlush(new DefaultSocks5CommandResponse(Socks5CommandStatus.SUCCESS,
