...
public class ServerUtils {
    ...
    public static void initSimpleHttpCapability(MitmServer mitmServer, HttpTrafficCapturer httpTrafficCapturer) {
        mitmServer.addChannelInitializer(new DefaultHttpRelayChannelInitializer());
        mitmServer.addCapturers(new DefaultHttpTrafficCapturer(httpTrafficCapturer));
    }
