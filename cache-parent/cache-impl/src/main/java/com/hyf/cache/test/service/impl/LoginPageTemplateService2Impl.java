 ...
 */
@Component
public class LoginPageTemplateService2Impl implements ILoginPageTemplateService2
{
    ...
    @Override
    public LoginPageTemplate findLoginPageTemplate(String rowGuid, String txt) {
        System.out.println("findLoginPageTemplate业务方法进入");
